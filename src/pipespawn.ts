...
export interface SpawnOptions {
  // if true, use OS default tmpdir as working directory
  useTmpDir?: boolean
  // if true, use specified path as working directory
  workingDir?: string
  // if specified, this file will created and written to before execution
  inFile?: string
  // if specified, this file will be read from after execution instead of stdout
  outFile?: string
}
...
class SpawnOptionsImpl {
  public useTmpDir: boolean = false
 ...
 * @returns boolean
 */
export async function canAccessLocation (pathToLocation: string): Promise<boolean> {
  try {
